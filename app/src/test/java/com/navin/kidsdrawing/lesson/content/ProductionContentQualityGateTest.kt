...
class ProductionContentQualityGateTest {
    ...
    fun bundledReleaseCatalogPassesAndEmitsDeterministicReports() {
        ...
        assertEquals(36, report.lessonCount)
        assertEquals(11, report.ageBandCounts.getValue(com.navin.kidsdrawing.lesson.model.AgeBand.LITTLE_ARTISTS))
        assertEquals(21, report.ageBandCounts.getValue(com.navin.kidsdrawing.lesson.model.AgeBand.CREATIVE_EXPLORERS))
        assertEquals(20, report.ageBandCounts.getValue(com.navin.kidsdrawing.lesson.model.AgeBand.GROWING_ARTISTS))
        assertEquals(13, report.ageBandCounts.getValue(com.navin.kidsdrawing.lesson.model.AgeBand.YOUNG_ARTISTS))
        assertEquals(8, report.difficultyCounts.getValue(1))
        assertEquals(12, report.difficultyCounts.getValue(2))
        assertEquals(9, report.difficultyCounts.getValue(3))
        assertEquals(6, report.difficultyCounts.getValue(4))
        ...
        assertEquals(36, parsed.getValue("lessonCount").jsonPrimitive.content.toInt())
